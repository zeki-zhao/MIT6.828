...
umain(int argc, char **argv)
{
  ...
  800040:	0f 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 e7 00 00 00       	call   80012f <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  8000f7:	68 cf 0f 80 00       	push   $0x800fcf
  8000fc:	6a 23                	push   $0x23
  8000fe:	68 ec 0f 80 00       	push   $0x800fec
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800178:	68 cf 0f 80 00       	push   $0x800fcf
  80017d:	6a 23                	push   $0x23
  80017f:	68 ec 0f 80 00       	push   $0x800fec
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ba:	68 cf 0f 80 00       	push   $0x800fcf
  8001bf:	6a 23                	push   $0x23
  8001c1:	68 ec 0f 80 00       	push   $0x800fec
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8001fc:	68 cf 0f 80 00       	push   $0x800fcf
  800201:	6a 23                	push   $0x23
  800203:	68 ec 0f 80 00       	push   $0x800fec
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80023e:	68 cf 0f 80 00       	push   $0x800fcf
  800243:	6a 23                	push   $0x23
  800245:	68 ec 0f 80 00       	push   $0x800fec
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800280:	68 cf 0f 80 00       	push   $0x800fcf
  800285:	6a 23                	push   $0x23
  800287:	68 ec 0f 80 00       	push   $0x800fec
...
sys_ipc_recv(void *dstva)
{
  ...
  8002e4:	68 cf 0f 80 00       	push   $0x800fcf
  8002e9:	6a 23                	push   $0x23
  8002eb:	68 ec 0f 80 00       	push   $0x800fec
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800319:	56                   	push   %esi
  80031a:	50                   	push   %eax
  80031b:	68 fc 0f 80 00       	push   $0x800ffc
  ...
  80032c:	e8 54 00 00 00       	call   800385 <vcprintf>
	cprintf("\n");
  800331:	c7 04 24 20 10 80 00 	movl   $0x801020,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800484:	0f be 80 22 10 80 00 	movsbl 0x801022(%eax),%eax
  80048b:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800618:	50                   	push   %eax
  800619:	68 3a 10 80 00       	push   $0x80103a
  80061e:	53                   	push   %ebx
  80061f:	56                   	push   %esi
  ...
  800633:	52                   	push   %edx
  800634:	68 43 10 80 00       	push   $0x801043
  800639:	53                   	push   %ebx
  80063a:	56                   	push   %esi
  ...
  80065e:	b8 33 10 80 00       	mov    $0x801033,%eax
