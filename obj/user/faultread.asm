	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d7:	0f be 80 e8 0f 80 00 	movsbl 0x800fe8(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800299:	ff 24 85 a0 10 80 00 	jmp    *0x8010a0(,%eax,4)
  ...
  80036b:	50                   	push   %eax
  80036c:	68 00 10 80 00       	push   $0x801000
  800371:	53                   	push   %ebx
  800372:	56                   	push   %esi
  ...
  800386:	52                   	push   %edx
  800387:	68 09 10 80 00       	push   $0x801009
  80038c:	53                   	push   %ebx
  80038d:	56                   	push   %esi
  ...
  8003b1:	b8 f9 0f 80 00       	mov    $0x800ff9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ad9:	68 28 12 80 00       	push   $0x801228
  800ade:	6a 23                	push   $0x23
  800ae0:	68 45 12 80 00       	push   $0x801245
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b5a:	68 28 12 80 00       	push   $0x801228
  800b5f:	6a 23                	push   $0x23
  800b61:	68 45 12 80 00       	push   $0x801245
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b9c:	68 28 12 80 00       	push   $0x801228
  800ba1:	6a 23                	push   $0x23
  800ba3:	68 45 12 80 00       	push   $0x801245
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bde:	68 28 12 80 00       	push   $0x801228
  800be3:	6a 23                	push   $0x23
  800be5:	68 45 12 80 00       	push   $0x801245
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c20:	68 28 12 80 00       	push   $0x801228
  800c25:	6a 23                	push   $0x23
  800c27:	68 45 12 80 00       	push   $0x801245
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c62:	68 28 12 80 00       	push   $0x801228
  800c67:	6a 23                	push   $0x23
  800c69:	68 45 12 80 00       	push   $0x801245
...
sys_ipc_recv(void *dstva)
{
  ...
  800cc6:	68 28 12 80 00       	push   $0x801228
  800ccb:	6a 23                	push   $0x23
  800ccd:	68 45 12 80 00       	push   $0x801245
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cfb:	56                   	push   %esi
  800cfc:	50                   	push   %eax
  800cfd:	68 54 12 80 00       	push   $0x801254
  ...
  800d0e:	e8 c5 f3 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800d13:	c7 04 24 dc 0f 80 00 	movl   $0x800fdc,(%esp)
